...
def main(args):
    ...
    training_config = TrainingConfig(
        ...
        log_path=None,
        save_path=None,
        exp_name=f"Exp3_Annotator{args.train_annotator}_vs_Annotator{args.test_annotator}"
    )
    ...
    test_path = discriminator.preprocess_custom_folder(
        input_images_folder=f'{nnunet_folders_path}/nnUNet_raw/{nnunet_dataset}/imagesTs',#
        input_segs_folder=f'{nnunet_folders_path}/nnUNet_raw/{nnunet_dataset_disc}/labelsTs_{args.train_annotator}', # same annotator that in traininig
        folder_name='test'
    )
    ...
    discriminator.set_datasets(
        ...
        val_data=val_data,
        test_dataset_train_domain=just_in_train_for_infer,
        test_dataset_inference_domain=just_in_train_for_infer,
    )
    ...
    output_base = f"Exp_3_annotator{args.train_annotator}_vs_annotator{args.test_annotator}"
